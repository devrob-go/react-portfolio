			...
			<div className="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center py-6">
				...
				<div className="flex justify-between items-center px-4 sm:px-0">
					...
					>
						{activeTheme === 'dark' ? (
							...
							<FiSun className="text-gray-500 hover:text-gray-200 text-xl" />
						)}
					</div>
				...
				<div className="sm:flex sm:justify-between sm:items-center ">
					...
					<div className="hidden sm:flex justify-between items-center flex-col md:flex-row">
						...
						>
							{activeTheme === 'dark' ? (
								<FiMoon className="text-gray-500 hover:text-gray-700 dark:text-ternary-light dark:hover:text-primary-light text-sm" />
							) : (
								<FiSun className="text-gray-500 hover:text-gray-200 text-sm" />
							)}
						</div>
					</div>
				</div>
